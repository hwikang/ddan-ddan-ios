...
public struct PetsNetwork {
    ...
    public func postPetFeed(accessToken: String, petId: String) async -> Result<DailyInfo, NetworkError> {
        let parameter: Parameters = [
            "petId": petId
        ]
        let headers: HTTPHeaders = ["Authorization": "Bearer " + accessToken]
    ...
    public func postPetPlay(accessToken: String, petId: String) async -> Result<DailyInfo, NetworkError> {
        let parameter: Parameters = [
            "petId": petId
        ]
        let headers: HTTPHeaders = ["Authorization": "Bearer " + accessToken]
